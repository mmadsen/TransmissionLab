...
public class XMLModelFactory {
    private String xmlModelConfigPath = null;

    public XMLModelFactory(String xmlModelConfigPath) {
        this.xmlModelConfigPath = xmlModelConfigPath;
    }

    public ISimulationModel generateModel() {
        return null;
    }
