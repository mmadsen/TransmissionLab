 ...
 *
 */
public interface IAgentSetFactory {
	// construct a random population of agents, with structure depending upon the factory we use
    // The factory implementing this interface needs to have a reference to an ISimulationModel
    // object from which it gathers the necessary parameters.
